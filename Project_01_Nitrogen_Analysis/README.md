...
* **Diminishing Returns:** Increasing from 100 kg/ha to 150 kg/ha did not yield a statistically significant gain.

---

## 📈 Visualizing Treatment Differences

![Maize Yield Boxplot](nitrogen_yield_boxplot.png)
...
* **Language/Environment:** R / RStudio (`ggplot2`, `dplyr`)
* **Script:** `nitrogen_analysis.R`
